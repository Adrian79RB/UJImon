...
class UjimonInstances {
    val ujimonArray: Array<Ujimon> = Array<Ujimon>(10) {
        Ujimon(0f, "", null, null, false, Type.NORMAL, Pair(0, Type.NORMAL))
    }

    init {
        ujimonArray[0] = Ujimon(1000f, "Maglug", Assets.assetsCombat[0], Assets.assetsButton[0], false, Type.FIRE,Pair(0, Type.NORMAL))
        ...
        ujimonArray[1] = Ujimon(1000f, "Obsho", Assets.assetsCombat[1], Assets.assetsButton[1], false, Type.DARKNESS,Pair(0, Type.NORMAL))
        ...
        ujimonArray[2] = Ujimon(1000f, "Redash", Assets.assetsCombat[2], Assets.assetsButton[2], false, Type.PLANT,Pair(0, Type.NORMAL))
        ...
        ujimonArray[3] = Ujimon(1000f, "Sworsth", Assets.assetsCombat[3], Assets.assetsButton[3], false, Type.DARKNESS,Pair(0, Type.NORMAL))
        ...
        ujimonArray[4] = Ujimon(1000f, "Aracleaf", Assets.assetsCombat[4], Assets.assetsButton[4],false, Type.PLANT,Pair(0, Type.NORMAL))
        ...
        ujimonArray[5] = Ujimon(1000f, "Bolhip", Assets.assetsCombat[5], Assets.assetsButton[5],false, Type.GROUND,Pair(0, Type.NORMAL))
        ...
        ujimonArray[6] = Ujimon(1000f, "Conder", Assets.assetsCombat[6], Assets.assetsButton[6],false, Type.WATER,Pair(0, Type.NORMAL))
        ...
        ujimonArray[7] = Ujimon(1000f, "Dihap", Assets.assetsCombat[7], Assets.assetsButton[7],false, Type.FIRE,Pair(0, Type.NORMAL))
        ...
        ujimonArray[8] = Ujimon(1000f, "Golroc", Assets.assetsCombat[8], Assets.assetsButton[8],false, Type.GROUND,Pair(0, Type.NORMAL))
        ...
        ujimonArray[9] = Ujimon(1000f, "Serwat", Assets.assetsCombat[9], Assets.assetsButton[9], false, Type.WATER,Pair(0, Type.NORMAL))
